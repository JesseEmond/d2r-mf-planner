...
for file in treasureclassex.txt itemratio.txt weapons.txt armor.txt monstats.txt misc.txt superuniques.txt uniqueitems.txt setitems.txt itemtypes.txt monlvl.txt; do
    echo "Fetching $file..."
