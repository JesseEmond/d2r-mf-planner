...
for file in treasureclassex.txt itemratio.txt weapons.txt armor.txt monstats.txt misc.txt superuniques.txt uniqueitems.txt setitems.txt sets.txt itemtypes.txt monlvl.txt magicprefix.txt magicsuffix.txt runes.txt skills.txt; do
    echo "Fetching $file..."
