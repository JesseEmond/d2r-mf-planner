...
export const PRESET_ITEMS = {
  head: [
    { id: 'shako',    name: "Harlequin Crest",  fcr: 0,  mf: 50, allSkills: 2, coldSkills: 0 },
  ...
  amulet: [
    ...
    { id: 'eye_of_etlich',name: "The Eye of Etlich",        fcr: 0, mf: 0, allSkills: 1, coldSkills: 0 },
    { id: 'tal_ammy',     name: "Tal Rasha's Adjudication", fcr: 0, mf: 0, allSkills: 2, coldSkills: 0 },
    custom,
  ],
  weapon: [
    { id: 'oculus',     name: "The Oculus",       fcr: 30, mf: 50, allSkills: 3, coldSkills: 0 },
    ...
    { id: 'eschuta',    name: "Eschuta's Temper",  fcr: 40, mf: 0,  allSkills: 3, coldSkills: 0 },
    custom,
  ],
  shield: [
  ...
  armor: [
    { id: 'vipermagi', name: "Skin of the Vipermagi",   fcr: 30, mf: 0,   allSkills: 1, coldSkills: 0 },
    { id: 'tal_armor', name: "Tal Rasha's Guardianship", fcr: 0,  mf: 88,  allSkills: 0, coldSkills: 0 },
  ...
  gloves: [
    { id: 'magefist',   name: "Magefist",          fcr: 20, mf: 0, allSkills: 0, coldSkills: 0 },
  ...
  belt: [
    ...
    { id: 'goldwrap',  name: "Goldwrap",                    fcr: 0,  mf: 30, allSkills: 0, coldSkills: 0 },
  ...
  boots: [
    ...
    { id: 'silkweave',    name: "Silkweave",    fcr: 0, mf: 0,  allSkills: 0, coldSkills: 0 },
    { id: 'waterwalk',    name: "Waterwalk",    fcr: 0, mf: 0,  allSkills: 0, coldSkills: 0 },
    custom,
  ],
  ring1: [
    { id: 'soj',     name: "Stone of Jordan", fcr: 0,  mf: 0,  allSkills: 1, coldSkills: 0 },
