                ...
                <table class="upgrades-table">
                  <thead>
                    <tr>
                      ...
                      <th class="upgrades-th"><tooltip-popup text="Approximate trading price from Traderie. Prices use the 'good' tier ist value from Traderie listings — 'ist value' is Traderie's unit of account and does not mean literally one Ist rune.">Price</tooltip-popup> <tooltip-popup :text="priceSnapshotDate ? 'Price snapshot from ' + priceSnapshotDate + '. Filtered to: Ladder · PC · Softcore · Reign of the Warlock. Double-check prices on Traderie before trading — values fluctuate.' : 'Filtered to: Ladder · PC · Softcore · Reign of the Warlock. Double-check prices on Traderie before trading — values fluctuate.'"><span class="info-icon">i</span></tooltip-popup></th>
